...
This project is indexed by GitNexus as **bodylog** (941 symbols, 2409 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/bodylog/context` | Codebase overview, check index freshness |
| `gitnexus://repo/bodylog/clusters` | All functional areas |
| `gitnexus://repo/bodylog/processes` | All execution flows |
| `gitnexus://repo/bodylog/process/{name}` | Step-by-step execution trace |
